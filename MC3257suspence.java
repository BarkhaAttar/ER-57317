...
public class MC3257suspence {
    ...
    @FindBy(xpath="//span[contains(text(),'MC3257 - Workout Plan Event Question Answers from ')]")private WebElement value3257;
	...
	@FindBy(xpath="//body/div[@id='erWizardLayout']/form[@id='IntMCValueForm']/div[3]/div[2]/div[2]/div[1]/div[4]/div[1]/div[1]/div[4]/div[2]/div[1]/div[1]")private WebElement answer;
	...
	public MC3257suspence(WebDriver driver)
	{
	...
	public void clickonsearch(WebDriver driver) {
		search.sendKeys("MC3257");
		Actions act=new Actions(driver);
		act.sendKeys(Keys.ENTER).perform();
		act.moveToElement(value3257).click().build().perform();
		}
	...
	public void selectquestion(WebDriver driver) {
		question.click();
		question_search.sendKeys("SIN - son integer");
		Actions act=new Actions(driver);
		act.sendKeys(Keys.ENTER).build().perform();
	}
